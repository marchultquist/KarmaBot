...
console.log(chalk.bold.greenBright.bgBlack('KarmaBot V1<br />I have taken the source code from a previous bot https://github.com/PCJones/Ultimate-Splinterlands-Bot-V2 and used it as a base. I have then given it a update and added some more functionality. Please note I am a noobie programmer :) <br />If you require any support or assistance with the bot, please get hold of me on https://discord.gg/TQG2qj7wDZ or via WhatsApp on +27836166292'));
            console.log(chalk.bold.greenBright.bgBlack('I will be implementing a private api shortly to stop the call limit being implemented on public api!'));     
        }
